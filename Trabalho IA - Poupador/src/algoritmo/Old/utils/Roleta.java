...
//            PesoDir aux = new PesoDir(MapsConsts.Direita,MapsConsts.MapHap[Y][X+1]);
//            pesosDir.add(aux);
//            Soma+=MapsConsts.MapHap[Y][X+1];
//        }
//        if (U.MovementIsPossible(-1,0)) {
//            PesoDir aux = new PesoDir(MapsConsts.Esquerda,MapsConsts.MapHap[Y][X-1]);
//            pesosDir.add(aux);
//            Soma+=MapsConsts.MapHap[Y][X-1];
//        }
//        if (U.MovementIsPossible(0,-1)) {
//            PesoDir aux = new PesoDir(MapsConsts.Cima,MapsConsts.MapHap[Y-1][X]);
//            pesosDir.add(aux);
//            Soma+=MapsConsts.MapHap[Y-1][X];
//        }
//        if (U.MovementIsPossible(0,1)) {
//            PesoDir aux = new PesoDir(MapsConsts.Baixo,MapsConsts.MapHap[Y+1][X]);
//            pesosDir.add(aux);
//            Soma+=MapsConsts.MapHap[Y+1][X];
//        }
